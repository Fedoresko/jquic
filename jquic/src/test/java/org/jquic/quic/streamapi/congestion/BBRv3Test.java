...
class BBRv3Test {
    ...
    void testInitialGetDelay() {
        ...
        long delay = bbr.getDelay(currentTime, 1200, 1, 0, 100, 100, 100,
    ...
    void testBwEstimateAndCwndGrowth() {
        ...
        delay = bbr.getDelay(currentTime, 1200, 1, 0, 100, 100, 100,
    ...
    void testStartupToDrainTransition() {
        ...
        bbr.getDelay(currentTime, 1200, 1, 0, 100, 100, 100,
                    10000, 0, 10000, 0, 8, 0, 0, 10000, 0, 0, 0);
    ...
    @Test
    void testPacingDelay() throws InterruptedException {
        // BW = 10000 / 100 = 100 bytes/ms
    ...
    @Test
    void testProbeRttTransition() throws Exception {
        ...
        long delay = bbr.getDelay(currentTime, 6000, 1, 0, 100, 100, 100,
                                 0, 0, 0, 0, 8, 0, 0, 10000, 0, 0, 0);
        assertTrue(delay > 0, "Should be blocked by reduced CWND in PROBE_RTT. delay=" + delay);

        // 3. Stay in PROBE_RTT for 200ms
        currentTime += 100;
        delay = bbr.getDelay(currentTime, 6000, 1, 0, 100, 100, 100,
                           0, 0, 0, 0, 8, 0, 0, 10000, 0, 0, 0);
    ...
    void testProbeBwCycles() {
        ...
        long delayDown = bbr.getDelay(currentTime, 1000, 1, 0, 100, 100, 100,
        ...
        long delayCruise = bbr.getDelay(currentTime, 1000, 1, 0, 100, 100, 100,
                                       10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayRefill = bbr.getDelay(currentTime, 1000, 1, 0, 100, 100, 100,
                                       10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayUp = bbr.getDelay(currentTime, 1000, 1, 0, 100, 100, 100,
                                   10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayDownFinal = bbr.getDelay(currentTime, 1000, 1, 0, 100, 100, 100,
                                          10000, 0, 10000, 0, 8, 0, 13000, 10000, 0, 0, 0);
