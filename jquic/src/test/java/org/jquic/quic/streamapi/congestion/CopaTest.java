...
class CopaTest {
    ...
    void testInitialGetDelay() {
        ...
        long delay = copa.getDelay(0, currentTime, 1200, 1, 100, 100, 100,
    ...
    void testWindowGrowthWhenLowDelay() {
        ...
        copa.getDelay(0, currentTime, 1200, 1, 100, 100, 100,
                    0, 0, 0, 0, 0, 0, 0, 0, 10000, 0, 0, 0);
    ...
    void testWindowReductionWhenHighDelay() {
        ...
        // Simulate ACK of one CWND over 100ms
        currentTime += 100;
        copa.getDelay(0, currentTime, 1200, 1, 100, 200, 100,
                    12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 0, 0);
    ...
    void testVelocityDoubling() {
        ...
        currentTime += 100;
        copa.getDelay(0, currentTime, 1200, 1, 100, 100, 100,
                    currentCwnd, 0, currentCwnd, 0, 10, 0, 0, 0, 10000, 0, 0, 0);
    ...
    void testVelocityReset() {
        ...
        currentCwnd = copa.getCwnd();
        currentTime += 100;
        copa.getDelay(0, currentTime, 1200, 1, 100, 500, 100,
                    currentCwnd, 0, currentCwnd, 0, 10, 0, 0, 0, 10000, 0, 0, 0);
    ...
    void testPacing() {
        ...
        long delay = copa.getDelay(0, currentTime, 1200, 1, 100, 100, 100,
                                 0, 0, 0, 0, 0, 0, 0, 1200, 10000, 0, 0, 0);
