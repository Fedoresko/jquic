...
class TcpPragueTest {
    ...
    void testInitialGetDelay() {
        ...
        long delay = prague.getDelay(currentTime, 1200, 1, 100, 100, 100,
    ...
    void testSlowStartGrowth() {
        ...
        prague.getDelay(currentTime, 1200, 1, 100, 100, 100,
    ...
    void testEcnAlphaUpdate() {
        ...
        prague.getDelay(currentTime + 10, 1200, 1, 100, 100, 100,
        ...
        prague.getDelay(currentTime + window + 10, 1200, 1, 100, 100, 100,
    ...
    void testEcnReactionGating() {
        ...
        prague.getDelay(currentTime + 1, 1200, 1, 100, 100, 100,
