...
class TcpPragueTest {
    ...
    void testInitialGetDelay() {
        ...
        long delay = prague.getDelay(0, currentTime, 1200, 1, 100, 100, 100,
    ...
    void testSlowStartGrowth() {
        ...
        prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
    ...
    void testEcnAlphaUpdate() {
        ...
        prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
                12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 2, 2);
        ...
        prague.getDelay((currentTime + 10) * 1_000_000L, currentTime + 10, 1200, 1, 100, 100, 100,
                12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 4, 2);
        ...
        prague.getDelay((currentTime + window + 10) * 1_000_000L, currentTime + window + 10, 1200, 1, 100, 100, 100,
                12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 6, 2);
    ...
    void testEcnCwndReduction() {
        ...
        prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
                12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 8, 8);
        ...
        prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
                12000, 0, 0, 0, 10, 0, 0, 0, 10000, 0, 8, 8);
    ...
    void testEcnReactionGating() {
        ...
        prague.getDelay((currentTime + 10) * 1_000_000L, currentTime + 10, 1200, 1, 100, 100, 100,
                12000, 0, 0, 0, 10, 0, 0, 0, 10000, 0, 8, 2);
        ...
        prague.getDelay((currentTime + 1) * 1_000_000L, currentTime + 1, 1200, 1, 100, 100, 100,
                12000, 0, 0, 0, 10, 0, 0, 0, 10000, 0, 10, 2);
    ...
    void testPacingDelay() {
        ...
        prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
                12000, 0, 12000, 0, 10, 0, 0, 0, 10000, 0, 0, 0);
        ...
        long delay = prague.getDelay(currentTime * 1_000_000L, currentTime, 1200, 1, 100, 100, 100,
                0, 0, 0, 0, 0, 0, 0, 0, 10000, 0, 0, 0);
