...
public interface QuicApplicationProtocolConnectionHandler {
     ...
     */
    void onNewServerStreamAllocated(long streamId, DataOutputStream outputStream, QuicConnectionControl.StreamType streamType);
     ...
     * @param outputStream stream for writing stream frames, blocks writing thread by congestion control and buffer limits.
     */
    void onNewClientStreamAllocated(long streamId, @NonNull QuicConnectionControl control, DataOutputStream outputStream, QuicConnectionControl.StreamType streamType);
     ...
     */
    void setOutgoingDatagramStream(DataOutputStream outputStream);
