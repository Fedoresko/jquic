...
class BBRv3Test {
    ...
    void testInitialCanSend() {
        ...
        long delay = bbr.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
    ...
    void testBwEstimateAndCwndGrowth() {
        ...
        delay = bbr.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
    ...
    void testStartupToDrainTransition() {
        ...
        bbr.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
                    10000, 0, 10000, 0, 8, 0, 0, 10000, 0, 0, 0);
    ...
    void testProbeBwCycles() {
        ...
        long delayDown = bbr.canSend(currentTime, 1000, 1, 0, 100, 100, 100, 
        ...
        long delayCruise = bbr.canSend(currentTime, 1000, 1, 0, 100, 100, 100, 
                                       10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayRefill = bbr.canSend(currentTime, 1000, 1, 0, 100, 100, 100, 
                                       10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayUp = bbr.canSend(currentTime, 1000, 1, 0, 100, 100, 100, 
                                   10000, 0, 10000, 0, 8, 0, 5000, 10000, 0, 0, 0);
        ...
        long delayDownFinal = bbr.canSend(currentTime, 1000, 1, 0, 100, 100, 100, 
                                          10000, 0, 10000, 0, 8, 0, 13000, 10000, 0, 0, 0);
