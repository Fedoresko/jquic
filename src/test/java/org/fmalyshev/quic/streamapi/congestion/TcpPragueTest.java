...
class TcpPragueTest {
    ...
    void testInitialCanSend() {
        ...
        long delay = prague.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
    ...
    void testEcnAlphaUpdate() {
        ...
        prague.canSend(currentTime + 10, 1200, 1, 0, 100, 100, 100, 
    ...
    void testEcnReactionGating() {
        ...
        prague.canSend(currentTime + 1, 1200, 1, 0, 100, 100, 100, 
