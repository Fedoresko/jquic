...
class FlightControlTest {
    ...
    void testStreamLimitEnforcementRFC() throws QuicStreamException {
        ...
        assertDoesNotThrow(() -> fc.openOutgoingStream(1, QuicStreamResponse.StreamType.Bidirectional));
        // 2nd Bidi (ID 5) should fail as peer only allows 1.
        assertThrows(QuicStreamException.class, () -> fc.openOutgoingStream(5, QuicStreamResponse.StreamType.Bidirectional));
    }
    ...
    void testStreamIdClassificationAndLimits() throws QuicStreamException {
        ...
        assertDoesNotThrow(() -> fc.openOutgoingStream(1, QuicStreamResponse.StreamType.Bidirectional));
        assertDoesNotThrow(() -> fc.openOutgoingStream(5, QuicStreamResponse.StreamType.Bidirectional));
        // 3rd Bidi (ID 9) should fail. Cap = 1 + 2 * 4 = 9.
        assertThrows(QuicStreamException.class, () -> fc.openOutgoingStream(9, QuicStreamResponse.StreamType.Bidirectional));

        // Server-initiated Uni: 3, 7...
        assertDoesNotThrow(() -> fc.openOutgoingStream(3, QuicStreamResponse.StreamType.Unidirectional));
        assertDoesNotThrow(() -> fc.openOutgoingStream(7, QuicStreamResponse.StreamType.Unidirectional));
        // 3rd Uni (ID 11) should fail. Cap = 3 + 2 * 4 = 11.
        assertThrows(QuicStreamException.class, () -> fc.openOutgoingStream(11, QuicStreamResponse.StreamType.Unidirectional));
    }
    ...
    void testFlowControlInteractionDetailed() throws QuicStreamException {
        ...
        fc.openOutgoingStream(1, QuicStreamResponse.StreamType.Bidirectional);
        ...
        fc.openOutgoingStream(5, QuicStreamResponse.StreamType.Bidirectional);
