...
class CopaTest {
    ...
    void testInitialCanSend() {
        ...
        long delay = copa.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
    ...
    void testWindowGrowthWhenLowDelay() {
        ...
        copa.canSend(currentTime, 1200, 1, 0, 100, 100, 100, 
                    0, 0, 0, 0, 0, 0, 0, 10000, 0, 0, 0);
    ...
    void testWindowReductionWhenHighDelay() {
        ...
        // Simulate ACK of one CWND over 100ms
        currentTime += 100;
        copa.canSend(currentTime, 1200, 1, 0, 100, 200, 100, 
                    12000, 0, 12000, 0, 10, 0, 0, 10000, 0, 0, 0);
    ...
    void testVelocityReset() {
        ...
        currentCwnd = copa.getCwnd();
        currentTime += 100;
        copa.canSend(currentTime, 1200, 1, 0, 100, 500, 100, 
                    currentCwnd, 0, currentCwnd, 0, 10, 0, 0, 10000, 0, 0, 0);
